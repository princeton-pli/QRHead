...
#
# This code is based on Qwen3MoE implementation from transformers v4.57.1.
# It has been modified to support QRRetriever's DynamicCacheWithQuery.
#
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if past_key_values is not None:
            ...
            if isinstance(past_key_values, DynamicCacheWithQuery):
                # For use in QRRetriever - cache query states at specified indices
...
class Qwen3MoeForCausalLM(Qwen3MoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # Skip logits computation if compute_logits=False (optimization for QRRetriever)
        if compute_logits:
